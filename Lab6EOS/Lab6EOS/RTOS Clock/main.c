...
osSemaphoreId_t semDisplayTime, semSecond, semMinute, semHour;
...
int main (void) {
	...
	LED_Initialize();
		...
		semSecond = osSemaphoreNew(1,0,NULL);
		...
		semDisplayTime = osSemaphoreNew(1,1,NULL);	// Create this semaphore as default to 1 ?
